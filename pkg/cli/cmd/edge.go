...
func printJoinCommand(name, edgeType, hubURL, joinToken string) {
	...
	if edgeType == "kubernetes" {
		fmt.Printf("To connect this Kubernetes cluster as an edge:\n\n")
		fmt.Printf("  # Persistent install (Deployment in kedge-system namespace):\n")
		...
		fmt.Printf("    --token %s\n", joinToken)
		fmt.Println()
		fmt.Printf("  # Or run as a foreground process (dev/containers):\n")
		...
		fmt.Printf("To connect this server as an edge:\n\n")
		fmt.Printf("  # Persistent install (systemd service, requires root):\n")
		fmt.Printf("  kedge agent join \\\n")
		fmt.Printf("    --hub-url %s \\\n", hubURL)
		fmt.Printf("    --edge-name %s \\\n", name)
		...
		fmt.Printf("    --token %s\n", joinToken)
		fmt.Println()
		fmt.Printf("  # Or run in foreground (dev/containers):\n")
		fmt.Printf("  kedge agent run \\\n")
		fmt.Printf("    --hub-url %s \\\n", hubURL)
		fmt.Printf("    --edge-name %s \\\n", name)
		fmt.Printf("    --type server \\\n")
