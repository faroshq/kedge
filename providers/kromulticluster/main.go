...
//
// kro-multicluster is a kedge provider that brokers application
...
import (
	...
	"github.com/faroshq/faros-kedge/providers/kromulticluster/kro"
	"github.com/faroshq/faros-kedge/providers/kromulticluster/mcpserver"
	"github.com/faroshq/faros-kedge/providers/kromulticluster/server"
	"github.com/faroshq/faros-kedge/providers/kromulticluster/tenant"
)
...
func main() {
	...
	go func() {
		log.Printf("kro-multicluster provider listening on :%s (kro=%T tenant=%v mcp=true)", port, kroClient, tenantFactory != nil)
