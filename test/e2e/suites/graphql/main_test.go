...
// Package graphql implements e2e tests for the kubernetes-graphql-gateway
// integrated with the kedge hub (kcp provider mode).
// Requires SetupClustersWithExternalKCP (--with-external-kcp flag).
package graphql
